...
const initialColumns = {
  todo: {
    title: 'To Do',
    tasks: [
      { id: 'task-1', title: 'Low',title1:'Brainstorming' ,content:"Brainstorming brings team members' diverse experience into play.",profile1:profile60,profile2:profile70,profile3:profile80},
      { id: 'task-2', title: 'High',title1:'Research' ,content:"User research helps you to create an optimal product for users.",profile1:profile70,profile2:profile80,},
  ...
  inProgress: {
    title: 'In Progress',
    tasks: [
      { id: 'task-4', title: 'Low',title1:'Onboarding Illustrations ',image10:image10,profile1:profile60,profile2:profile70,profile3:profile80},
      { id: 'task-5', title: 'Low',title1:'Moodboard',profile1:profile60,image20:image20,image30:image30},
    ],
    image1:point60,
    image2:dots10,
    ...
    tasks: [
      ...
      { id: 'task-7', title: 'Complected',title1:'Design System',content:'It just needs to adapt the UI from what you did before ',profile1:profile60,profile2:profile70,profile3:profile80 }
